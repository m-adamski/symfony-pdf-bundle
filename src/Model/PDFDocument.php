...
class PDFDocument {
     ...
     * @param int         $fontSize
     */
    public function __construct(Environment $twigEnvironment, string $orientation = "P", string $unit = "mm", string $format = "A4", bool $unicode = true, string $encoding = "UTF-8", int $fontSize = 10) {
